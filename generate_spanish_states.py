...
REPLACEMENTS = [
    ...
    ("with crime data from the FBI's Uniform Crime Reporting (UCR) program for", 'con datos de crimen del programa FBI UCR para'),
    ...
    ('All State Rankings', 'Todas las Clasificaciones de Estados'),
